...
function initMap() {
  ...
  // 1. Topographic Terrain (Primary - reveals mountain ridges, river gorges, elevation contours)
  ...
  // 2. Dark Matter (Night command center mode)
  ...
  // 3. Satellite Imagery (Satellite relief)
  APP.layers.sat = L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}", {
    maxZoom: 18,
    attribution: "Esri Satellite"
  });

  // Add Topo by default so terrain is immediately visible
